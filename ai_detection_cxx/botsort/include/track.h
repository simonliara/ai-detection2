...
using BotKalmanFilter = bot_kalman::BotKalmanFilter;
...
public:
     ...
     */
    void activate(BotKalmanFilter &kalman_filter, uint32_t frame_id);
     ...
     */
    void re_activate(BotKalmanFilter &kalman_filter, Track &new_track,
     ...
     */
    void predict(BotKalmanFilter &kalman_filter);
     ...
     * @param frame_id Current frame-id
     */
    void update(BotKalmanFilter &kalman_filter, Track &new_track,
                uint32_t frame_id);
