...
void Track::activate(BotKalmanFilter &kalman_filter, uint32_t frame_id)
{
    track_id = next_id();
...
void Track::re_activate(BotKalmanFilter &kalman_filter, Track &new_track,
...
void Track::predict(BotKalmanFilter &kalman_filter)
{
...
void Track::update(BotKalmanFilter &kalman_filter, Track &new_track,
                   uint32_t frame_id)
{
