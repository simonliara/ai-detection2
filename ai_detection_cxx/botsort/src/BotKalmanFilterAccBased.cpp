#include "BotKalmanFilterAccBased.h"

#include <eigen3/Eigen/Cholesky>

namespace acc_kalman
{
BotKalmanFilter::BotKalmanFilter(double dt)
...
void BotKalmanFilter::_init_kf_matrices(double dt)
{
...
KFDataStateSpace BotKalmanFilter::init(const DetVec &measurement) const
{
...
void BotKalmanFilter::predict(KFStateSpaceVec &mean,
                           KFStateSpaceMatrix &covariance)
{
...
BotKalmanFilter::project(const KFStateSpaceVec &mean,
...
KFDataStateSpace BotKalmanFilter::update(const KFStateSpaceVec &mean,
                                      const KFStateSpaceMatrix &covariance,
...
Eigen::Matrix<float, 1, Eigen::Dynamic> BotKalmanFilter::gating_distance(
